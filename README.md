...
3. **Trade** with the bank: **4:1** (give 4 of one resource, get 1 of any). With an outpost or city on a **port** (coastal vertex), trade **3:1**.
4. **Build** by clicking **highlighted** spots: **Hyperlane** (1 timber + 1 alloy), **Outpost** (1 timber, 1 alloy, 1 provisions, 1 rations; must touch your hyperlane, not adjacent to another building), **City** (upgrade outpost: 2 rations + 3 ore). Buy **development cards** (1 provisions + 1 rations + 1 ore): Knight, VP, Road Building, Year of Plenty, Monopoly.
5. Click **End turn** when done. First to **10 victory points** wins (outpost = 1 VP, city = 2 VP, Longest Road 2 VP, Largest Army 2 VP, VP cards).
